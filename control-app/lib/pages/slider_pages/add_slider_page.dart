...
class AddSliderPage extends StatefulWidget {
  const AddSliderPage({Key? key}) : super(key: key);
...
class _AddSliderPageState extends State<AddSliderPage> {
  ...
  String sliderTitleValue = "";
  String sliderSubtitleValue = "";
  String sliderImageValue = "";
  String sliderColorValue = "";
